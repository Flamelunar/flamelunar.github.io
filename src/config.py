...
class Configurable(object):
    ...
    @property
    def is_use_lstm(self):
        return self._conf.getint('Run', 'is_use_lstm') > 0

    @property
    def is_use_mamba(self):
        return self._conf.getint('Run', 'is_use_mamba') > 0
    ...
    @property
    def is_use_kan(self):
        return self._conf.getint('Run', 'is_use_kan') > 0
    
    @property
    def is_use_mlp(self):
        return self._conf.getint('Run', 'is_use_mlp') > 0
    ...
    @property
    def is_use_multi_head_attention(self):
        return self._conf.getint('Run', 'is_use_multi_head_attention') > 0
    
    @property
    def attention_head_num(self):
        return self._conf.getint('Run', 'attention_head_num')
    ...
    @property
    def mamba_layer_num(self):
        return self._conf.getint('Network', 'mamba_layer_num')
    ...
    @property
    def mamba_dropout_ratio(self):
        return self._conf.getfloat('Network', 'mamba_dropout_ratio')
    
    @property
    def subword_dropout(self):
        return self._conf.getfloat('Network','subword_dropout')
    
    @property
    def dropout_1(self):
        return self._conf.getfloat('Network', 'dropout_1')
    ...
    @property
    def kan_input_dropout_ratio(self):
        return self._conf.getfloat('Network', 'kan_input_dropout_ratio')

    @property
    def kan_output_dropout_ratio(self):
        return self._conf.getfloat('Network', 'kan_output_dropout_ratio')
